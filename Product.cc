...
Product::Product(const string& name, StoreLocation* loc):name(name), storeLocation(loc){
...
void Product::print()const{
	cout << "Product: "<< name<< " | Location: " << storeLocation->getId() << endl;
}
